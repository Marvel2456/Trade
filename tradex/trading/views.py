...
def signup_view(request):
    ...
    return render(request, 'trading/signup.html', context)
...
def login_view(request):
    ...
    return render(request, 'trading/login.html', context)
...
def make_trade(request):
    ...
    return render(request, 'trading/trader_dashboard.html', context)
